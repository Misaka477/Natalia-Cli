...
exports.HARD_PROTECTED_CONSTITUTION_RULE_IDS = void 0;
exports.isHardProtectedConstitutionRule = isHardProtectedConstitutionRule;
/**
 ...
 */
exports.HARD_PROTECTED_CONSTITUTION_RULE_IDS = new Set(["C-TERM-001", "C-TERM-002", "C-TERM-003"]);
/**
 ...
 */
function isHardProtectedConstitutionRule(ruleID) {
    return exports.HARD_PROTECTED_CONSTITUTION_RULE_IDS.has(ruleID);
}
