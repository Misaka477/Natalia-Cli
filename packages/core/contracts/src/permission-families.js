...
exports.PERMISSION_FAMILIES = void 0;
exports.classifyPermissionFamily = classifyPermissionFamily;
var FAMILIES = {
    filesystemRead: {
        id: "filesystem-read",
    ...
    managedProcess: {
        ...
        description: "Start, inspect, restart, and stop managed background processes.",
    ...
    network: {
        ...
        description: "Access remote network resources, including web and browser tools.",
    ...
    sandbox: {
        ...
        description: "Create, modify, execute, merge, and remove isolated sandboxes.",
...
for (var _i = 0, _a = Object.values(FAMILIES); _i < _a.length; _i++) {
    var family = _a[_i];
    Object.freeze(family);
}
exports.PERMISSION_FAMILIES = Object.freeze(FAMILIES);
var FILESYSTEM_READ_NAMES = new Set([
    "read_file",
    "read_media_file",
    "image_read",
    "glob",
...
var FILESYSTEM_WRITE_NAMES = new Set([
    "write_file",
    "edit_file",
    "apply_edits",
    "file_write",
 ...
 */
function classifyPermissionFamily(toolName, capabilityOwner) {
    ...
    if (name.startsWith("skill_"))
        return copyFamily(FAMILIES.skills);
    ...
    switch (capabilityOwner) {
        ...
        case "natalia-tool-web":
            return copyFamily(FAMILIES.network);
        case "natalia-subagents":
            return copyFamily(FAMILIES.agent);
        case "natalia-sandbox":
            return copyFamily(FAMILIES.sandbox);
        case "natalia-tool-todo":
            return copyFamily(FAMILIES.planning);
    }
    return {
        id: "tool:".concat(toolName),
        label: toolName,
        description: "Use the ".concat(toolName, " tool."),
        scope: "Only ".concat(toolName, " in this session"),
        sessionAction: "Allow ".concat(toolName, " for session"),
    };
}
function copyFamily(family) {
    return __assign({}, family);
}
