...
import { SplitDiffView, buildSplitRows } from "./SplitDiffView";
import type { StructuredDiffResult } from "@natalia/diff-wasm";
import { computeDiffInWorker, computeDiffInWorkerStream } from "./diff-client";
...
function structuredRows(result: StructuredDiffResult) {
  try {
