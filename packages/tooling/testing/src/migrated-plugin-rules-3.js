...
exports.migratedPluginRules3 = void 0;
exports.migratedPluginRules3 = [
    {
        id: "natalia-tool-ask",
        targets: [
        ...
        forbidden: [
            {
                ...
                pattern: /\b(?:WorkspaceSandboxManager|SnapshotSandboxManager|WorktreeSandboxManager)\b/u,
            },
            {
    ...
    },
    {
        ...
        forbidden: [
            ...
            },
            {
                ...
                pattern: /from\s+["'](?:\.\/checkpoint-controller|\.\.\/checkpoint-controller|\.\/checkpoint-controller-plugin|\.\/builtin-plugins\/checkpoint-controller-plugin)["']/u,
            },
            {
    ...
    },
    {
        ...
        forbidden: [
            ...
            },
            {
                ...
                pattern: /from\s+["'](?:\.\/(?:builtin-plugins\/)?team-plugin|\.\/team-tools|\.\/fan-out|\.\/agent-team-prompts|\.\.\/team-tools|\.\.\/fan-out)["']/u,
            },
            {
            ...
            },
            {
                ...
                pattern: /export\s+(?:async\s+)?(?:function|const)\s+(?:createTeamPlugin|createTeamFanoutTool|createTeamReviewTool|runFanOut|reviewPRs|validateOwnershipMap|ORCHESTRATOR_SYSTEM_PROMPT|TEAM_MODE_DIRECTIVE)\b/u,
            },
        ],
    },
    {
        ...
        forbidden: [
            {
                ...
                pattern: /from\s+["'](?:\.\.?\/)*(?:plan-ledger|drift-evaluator|work-graph|work-ledger-controller|work-ledger-plugin|builtin-plugins\/work-ledger-plugin)["']/u,
            },
            {
                description: "client-owned work ledger implementation",
                pattern: /export function (?:createWorkLedgerPlugin|createWorkLedgerController|buildPlanDraftCreated|createDriftEvaluator)\b/u,
            },
            {
        ...
        forbidden: [
            {
                ...
                pattern: /\b(?:attachmentDataURL|attachmentText|cleanupUnreferencedAttachments|isTextAttachment|referencedAttachmentsForSessions|storeLocalAttachments)\b/u,
            },
            {
        ...
        forbidden: [
            {
                ...
                pattern: /(?:from\s+["']\.\/command-dispatcher["']|\bcreateRealRuntimeClient\b|\bcreateHttpTransport(?:Plugin)?Host\b|\bcreateWorkflowScheduler(?:Plugin)?Host\b)/u,
            },
        ],
    },
];
