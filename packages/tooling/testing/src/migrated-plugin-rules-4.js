...
exports.migratedPluginRules4 = void 0;
exports.migratedPluginRules4 = [
    {
    ...
    },
    {
        ...
        forbidden: [
            ...
            },
            {
                ...
                pattern: /\b(?:fsWriteToolFamily|writeFileTools|createFsWritePlugin)\b/u,
            },
        ],
    },
    {
        ...
        forbidden: [
            {
                ...
                pattern: /from\s+["']@natalia\/(?:plugin-tool-terminal|plugin-native-terminal|tool-terminal)["']/u,
            },
            {
                description: "direct terminal tool construction",
                pattern: /\b(?:terminalToolFamily|terminalTools|createTerminalPlugin)\b/u,
            },
        ],
    },
    {
        ...
        targets: [
            "packages/framework/client/src/runtime/main.ts",
            "packages/framework/client/src/runtime/commands/index.ts",
        ],
        forbidden: [
            {
                description: "direct runtime config implementation import",
                pattern: /from\s+["'](?:\.\/runtime-config-plugin|\.\/builtin-plugins\/runtime-config-plugin)["']/u,
            },
            {
                description: "runtime config capability registration",
                pattern: /\b(?:registerRuntimeConfigCapability|RUNTIME_CONFIG_CAPABILITY_ID)\b/u,
            },
        ],
    },
    {
        ...
        forbidden: [
            {
                ...
                pattern: /\b(?:createWorkspaceWriteLock|createMutationRegistry|createWorkspaceFilesController)\b/u,
            },
            {
                description: "direct workspace implementation import",
                pattern: /from\s+["'](?:\.\.?\/)*(?:mutation-registry|workspace-change-auditor|workspace-files-controller|workspace-files|workspace-observation|workspace-write-lock|workspace-plugin|builtin-plugins\/workspace-plugin)["']/u,
            },
            {
                description: "client-owned workspace implementation",
                pattern: /export (?:async )?function (?:createWorkspacePlugin|createWorkspaceChangeAuditor|findWorkspaceFiles|watchWorkspaceFiles)\b/u,
            },
            {
                description: "client-owned workspace command implementation",
                pattern: /(?:findWorkspaceFiles|searchWorkspaceFiles|["']\/(?:files|search)["'])/u,
            },
        ],
    },
    {
        ...
        forbidden: [
            {
                ...
                pattern: /from\s+["'](?:\.\/session-store-controller|\.\/session-store-controller-plugin|\.\/builtin-plugins\/session-store-controller-plugin)["']/u,
            },
            {
    ...
    },
    {
        ...
        forbidden: [
            ...
            },
            {
                ...
                pattern: /from\s+["'](?:\.\/provider-model-controller|\.\/provider-runner|\.\/provider-model-plugin|\.\/builtin-plugins\/provider-model-plugin)["']/u,
            },
            {
        ...
        forbidden: [
            {
                ...
                pattern: /from\s+["'](?:\.\/context-ledger-factory|\.\/context-ledger-plugin|\.\/builtin-plugins\/context-ledger-plugin)["']/u,
            },
            {
        ...
        forbidden: [
            {
                ...
                pattern: /from\s+["'](?:\.\/retry-service|\.\/retry-plugin|\.\/builtin-plugins\/retry-plugin)["']/u,
            },
            {
    ...
    },
    {
        ...
        forbidden: [
            ...
            },
            {
                ...
                pattern: /from\s+["'](?:\.\/status-controller|\.\.\/status-controller|\.\/runtime-ui-plugin|\.\/builtin-plugins\/runtime-ui-plugin)["']/u,
            },
            {
