...
var apiReferenceTest = (0, node_path_1.join)(root, "packages", "hosts", "transport", "test", "api-reference.test.ts");
var result = (0, node_child_process_1.spawnSync)("bun", ["test", apiReferenceTest], {
    cwd: root,
    stdio: "ignore",
});
if (result.status === 0)
