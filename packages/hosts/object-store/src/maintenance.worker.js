...
port.on("message", function (request) {
    void (function () { return __awaiter(void 0, void 0, void 0, function () {
        var store, result, _a, response, error_1, response;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 5, , 6]);
                    globalThis.__NATALIA_OBJECT_STORE_NO_WORKER = true;
                    store = new object_store_1.ObjectStore(request.root);
                    if (!(request.op === "compact")) return [3 /*break*/, 2];
                    return [4 /*yield*/, store.compact()];
                case 1:
                    _a = _b.sent();
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, store.collectGarbage(new Set(request.reachable))];
                case 3:
                    _a = _b.sent();
                    _b.label = 4;
                case 4:
