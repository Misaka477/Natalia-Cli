...
(0, bun_test_1.test)("mailbox_status reads the complete hot state without resolving the store", function () { return __awaiter(void 0, void 0, void 0, function () {
    var exec, ctx, messages;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                exec = {
                    session: { id: "ses_mailbox_status", events: [] },
                    factState: (0, session_1.sessionFactStateFromEvents)([queued]),
                ...
                return [4 /*yield*/, (0, collab_1.mailboxMessagesForStatus)(ctx, exec)];
            case 1:
                messages = _a.sent();
