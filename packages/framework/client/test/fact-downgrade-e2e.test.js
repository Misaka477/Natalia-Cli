 ...
 */
(0, bun_test_1.test)("terminal facts are downgraded in hot memory yet still read in full", function () { return __awaiter(void 0, void 0, void 0, function () {
    var root, sessionID, client, i, page;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, (0, plugin_test_helpers_1.officialPluginWorkspace)("fact-downgrade-e2e")];
            case 1:
                root = _b.sent();
                sessionID = "ses_fact_downgrade";
            ...
            case 3:
                ...
                return [4 /*yield*/, client.recordDecision({ decision: "decision ".concat(i) }, sessionID)];
            case 4:
                _b.sent();
                _b.label = 5;
            case 5:
                i += 1;
                return [3 /*break*/, 3];
            case 6: return [4 /*yield*/, client.decisionRecords({
                    sessionID: sessionID,
                    scope: "session",
                })];
            case 7:
                ...
                (0, bun_test_1.expect)(page.total).toBe(300);
                (0, bun_test_1.expect)(page.items).toHaveLength(300);
                // The oldest decision (evicted from hot memory) is still served.
                (0, bun_test_1.expect)(page.items.some(function (d) { return d.decision === "decision 0"; })).toBe(true);
