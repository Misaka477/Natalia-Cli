...
test("capabilities() surfaces each capability's effective contributions", async () => {
  ...
  try {
    ...
    // Framework subsystems and plugins both expose their effective runtime
    // contributions through the same capability query.
    const terminal = records?.find(
      (record) => record.id === "natalia-tool-terminal",
    );
    expect(terminal?.contributions).toEqual([
      { kind: "services", name: "terminal.controller" },
      { kind: "tools", name: "interactive_terminal_start" },
      { kind: "tools", name: "terminal_observe" },
      { kind: "tools", name: "interactive_terminal_read" },
      { kind: "tools", name: "interactive_terminal_search" },
      { kind: "tools", name: "interactive_terminal_write" },
      { kind: "tools", name: "interactive_terminal_send_line" },
      { kind: "tools", name: "interactive_terminal_keys" },
      { kind: "tools", name: "interactive_terminal_input" },
      { kind: "tools", name: "interactive_terminal_snapshot" },
      { kind: "tools", name: "interactive_terminal_resize" },
      { kind: "tools", name: "interactive_terminal_request_human" },
      { kind: "tools", name: "interactive_terminal_stop" },
      { kind: "tools", name: "interactive_terminal_list" },
    ]);
    ...
    expect(sandbox?.contributions).toEqual([
      ...
      { kind: "tools", name: "sandbox_create" },
      { kind: "tools", name: "sandbox_execute" },
      { kind: "tools", name: "sandbox_write" },
      { kind: "tools", name: "sandbox_diff" },
      { kind: "tools", name: "sandbox_merge" },
      { kind: "tools", name: "sandbox_delete" },
      { kind: "tools", name: "sandbox_resource_start" },
      { kind: "tools", name: "sandbox_resource_list" },
      { kind: "tools", name: "sandbox_resource_output" },
      { kind: "tools", name: "sandbox_resource_stop" },
    ]);
