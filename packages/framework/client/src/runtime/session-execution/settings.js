...
exports.createSettingsSurface = createSettingsSurface;
var config_1 = require("@natalia/config");
function createSettingsSurface(ctx, options) {
    return {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, (0, config_1.resolveTuiConfig)(ctx.ports.getWorkspaceRoot())];
                        case 2:
                            resolved = _a.sent();
                            return [2 /*return*/, {
        ...
        settingsSet: function (patch, scope) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, ctx.ports.getReady()];
                        case 1:
                            ...
                            return [4 /*yield*/, (0, config_1.saveTuiConfig)(ctx.ports.getWorkspaceRoot(), patch, scope)];
                        case 2:
                            // The interface-preference file, served publicly now that the TUI no
                            // longer owns it privately. Validated by the shared schema (an invalid
                            // patch is an argument error, not a partial write), written atomically,
                            // then announced so subscribers can re-read.
                            _a.sent();
                            ctx.ports.publish({ type: "settings.updated", scope: scope });
