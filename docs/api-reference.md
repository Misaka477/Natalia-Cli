...
| `CheckpointPreview`          | `checkpointID`: string, `safetyCheckpointID?`: string, `dryRun`: boolean, `resources`: CheckpointResourcePolicy[], `ignoredFiles`: number, `diskUsageBytes`: number, `complete`: boolean, `warnings`: string[]                                                                                                                                                                        |
...
| `MCPPromptCatalog`           | `server`: string, `name`: string, `description?`: string                                                                                                                                                                                                                                                                                                                              |
...
| `RuntimeCapabilityReport`    | `apiVersion`: number, `usable`: boolean, `missingRequired`: RequiredRuntimeMember[], `channel?`: ChannelCapabilityReport                                                                                                                                                                                                                                                              |
...
| `ScheduledTaskRow`           | `taskID`: string, `displayName`: string, `path`: string, `schedule`: string, `permissionProfile`: string, `flowID`: string, `enabledModules`: number, `retry`: NataliaTaskDocument["retry"], `alertChannels`: string[], `alertEvents`: string[], `issueTarget?`: string, `dataSource?`: string, `consecutiveFailures`: number, `pendingAlertDeliveries`: number, `problems`: string[] |
