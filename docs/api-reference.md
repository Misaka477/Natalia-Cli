...
### Capability groups (21 groups · 168 optional members)
...
### RPC route table (173 methods → members)
...
- Runtime event types (`RuntimeEventData` union): 111.
- view-store projections (`case` labels in `packages/hosts/view-store/src`): 117.
...
| `constitution.rule_updated`     | `id`: string, `ruleID`: string, `statement?`: string, `priority?`: "critical" | "high" | "medium" | "low", `enforcement?`: "deny" | "approval" | "warn", `overridePolicy?`: "forbidden" | "user_scoped" | "user_explicit"                                                                                                                                                                                                                                                                                                  | a constitution rule was updated                                                     |
