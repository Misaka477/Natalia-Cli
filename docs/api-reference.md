...
| `evidenceRecords`                   | `evidence.records`                   | `sessionID?`: string                                                                                                                                                                                                                                                                                                                                                                                                               | GovernancePage<{ taskID: string; objective: string; status: string; effectiveStatus?: string; changes: Array<{ path: string; changeType: "added" | "modified" | "deleted"; summary: string; }>; validations: Array<{ command: string; result: "passed" | "failed" | "skipped"; safeSummary: string; durationMs?: number; }>; knownGaps: string[]; }>                                                                                                                     |
