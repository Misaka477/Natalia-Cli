...
| `context.status`                | `channel?`: ChatChannel, `used`: number, `max`: number, `source`: ContextStatusSource, `thresholdPercent`: number, `reserved`: number, `trigger?`: CompactionTrigger                                                                                                                                                                                                                                                                                                                                                       | the context ledger status changed (token estimate vs configured limits)             |
| `context.snapshot`              | `channel?`: ChatChannel, `usedTokens`: number, `pressureTokens?`: number, `projectedTokens?`: number, `contextWindow?`: number, `source`: "estimate" | "provider_usage", `at`: string                                                                                                                                                                                                                                                                                                                                      | —                                                                                   |
| `navi.context.status`           | `used`: number, `max`: number, `source`: ContextStatusSource, `thresholdPercent`: number, `reserved`: number, `trigger?`: CompactionTrigger                                                                                                                                                                                                                                                                                                                                                                                | —                                                                                   |
| `nia.context.status`            | `used`: number, `max`: number, `source`: ContextStatusSource, `thresholdPercent`: number, `reserved`: number, `trigger?`: CompactionTrigger                                                                                                                                                                                                                                                                                                                                                                                | —                                                                                   |
| `navi.context.snapshot`         | `usedTokens`: number, `pressureTokens?`: number, `projectedTokens?`: number, `contextWindow?`: number, `source`: "estimate" | "provider_usage", `at`: string                                                                                                                                                                                                                                                                                                                                                               | —                                                                                   |
| `nia.context.snapshot`          | `usedTokens`: number, `pressureTokens?`: number, `projectedTokens?`: number, `contextWindow?`: number, `source`: "estimate" | "provider_usage", `at`: string                                                                                                                                                                                                                                                                                                                                                               | —                                                                                   |
