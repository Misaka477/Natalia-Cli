...
### Capability groups (21 groups · 183 optional members)
...
| chat           | `chatSubmit` · `chatAbort` · `chatMessages` · `chatMessagesPage` · `chatRollback` · `chatModelProfile` · `setChatModelProfile`                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |

### RPC route table (188 methods → members)
...
- Runtime event types (`RuntimeEventData` union): 120.
- view-store projections (`case` labels in `packages/hosts/view-store/src`): 123.
