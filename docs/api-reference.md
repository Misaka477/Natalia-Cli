...
### Capability groups (21 groups · 182 optional members)
...
### RPC route table (187 methods → members)
...
- Runtime event types (`RuntimeEventData` union): 119.
...
| `constitutionRules`                 | `constitution.rules`                 | `sessionID?`: string                                                                                                                                                                                                                                                                                                                                                                                                               | Array<{ ruleID: string; statement: string; scope: "project" | "package" | "sandbox" | "task" | "release"; priority: "critical" | "high" | "medium" | "low"; source: "user" | "master_plan" | "policy" | "agent_proposed"; enforcement: "deny" | "approval" | "warn"; overridePolicy: "forbidden" | "user_scoped" | "user_explicit"; appliesTo?: { tools?: string[]; paths?: string[]; commandPattern?: string; }; }>                                  |
| `decisionRecords`                   | `decision.records`                   | `sessionID?`: string                                                                                                                                                                                                                                                                                                                                                                                                               | Array<{ id: string; scope: "session" | "workspace"; decision: string; rationale: string[]; alternatives: { option: string; rejectedReason?: string }[]; consequences: string[]; status: "proposed" | "accepted" | "superseded"; linkedPlans: string[]; linkedConstraints: string[]; }>                                                                                                                                                                |
...
| `driftFindings`                     | `drift.findings`                     | `sessionID?`: string                                                                                                                                                                                                                                                                                                                                                                                                               | Array<{ findingID: string; severity: "advisory" | "warning" | "high"; confidence: number; originalObjective: string; currentActivity: string; evidence: string[]; applicableConstraints: string[]; status: | "open" | "explained" | "disputed" | "dismissed" | "corrected" | "detour_declared"; reopenedCount: number; rationale?: string; contractVersion: number; ruleHits: Array<{ rule: string; confidence: number }>; planID?: string; }>        |
