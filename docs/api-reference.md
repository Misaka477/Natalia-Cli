...
### Capability groups (20 groups · 131 optional members)
...
### RPC route table (136 methods → members)
...
- Runtime event types (`RuntimeEventData` union): 105.
- view-store projections (`case` labels in `packages/hosts/view-store/src`): 87.
