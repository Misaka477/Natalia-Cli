...
| `evidence.recorded`             | `id`: string, `taskID`: string, `objective`: string, `knownGaps?`: string[], `recordedAt?`: string, `environment?`: string                                                                                                                                                                                                                                                                                                                                                                                                 | evidence for a task objective was recorded; no writer yet                           |
