...
- Runtime event types (`RuntimeEventData` union): 102.
- view-store projections (`case` labels in `packages/view-store/src`): 83.
...
| `turn.submitted`            | `id`: string, `text`: string, `byteLength`: number, `lineCount`: number, `sha256`: string, `delivery?`: "steer"                                                                                                                                      | "queue", `attachments?`: LocalAttachment[], `resources?`: PromptResourceMention[], `agents?`: PromptAgentMention[]                                                                                                                                                                                                                               | a turn was accepted; `id` is the turn id                                                                                                                                                                                                   |
