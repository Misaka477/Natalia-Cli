...
```json
{ "jsonrpc": "2.0", "method": "event", "params": { "id": 42, "event": { "type": "content.delta", "id": "turn_1", "text": "hi" } } }
```
...
| `checkpoint.created`        | `id`: string, `reason`: string, `sequence`: number, `complete`: boolean, `files`: number, `changes`: number, `contextJournalOffset`: number, `step`: number, `tokenEstimate`: number, `diskUsageBytes`: number                                                                                                                                                                                                                                                                                                             | a durable checkpoint was created (turn start, compaction, context-limit recovery)   |
...
| `rollback.begin`            | `checkpointID`: string, `safetyCheckpointID`: string, `dryRun?`: boolean                                                                                                                                                                                                                                                                                                                                                                                                                                                   | a workspace rollback started                                                        |
| `rollback.end`              | `checkpointID`: string, `safetyCheckpointID`: string, `restoredFiles`: number, `deletedFiles`: number, `contextJournalOffset`: number, `step`: number                                                                                                                                                                                                                                                                                                                                                                      | a workspace rollback finished                                                       |
| `rollback.failed`           | `checkpointID`: string, `safetyCheckpointID?`: string, `message`: string, `recovered`: boolean                                                                                                                                                                                                                                                                                                                                                                                                                             | a workspace rollback failed                                                         |
...
| `turn.finished`             | `id`: string, `stopReason`: "done" | "cancelled" | "error", `reason?`: "missing_final_response"                                                                                                                                                                                                                                                                                                                                                                                                                            | a turn ended; `stopReason`: done, cancelled or error                                |
<!-- /api-reference:generated -->
