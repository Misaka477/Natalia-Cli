...
| `thinking.done`                 | `id`: string, `text?`: string, `visible?`: boolean, `attempt?`: number, `reasoningField?`: string, `reasoningSignature?`: string, `reasoningRedacted?`: boolean                                                                                                                                                                                                                                                                                                                                                            | completed reasoning text; journaled                                                 |
