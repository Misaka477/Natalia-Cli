...
### Capability groups (20 groups · 144 optional members)
...
| workspace      | `workspaceFiles` · `workspaceSearch` · `workspaceList` · `workspaceRead` · `workspaceWrite` · `workspaceGlob` · `workspaceDiff` · `workspaceGitDiff` · `gitRefs` · `workspaceRoots` · `workspaceAdd` · `workspaceRemove` · `workspaceActivate` · `workspacePermissionGet` · `workspacePermissionSet` · `workspaceToolGet` · `workspaceToolSet`          |
...
### RPC route table (149 methods → members)
...
| `reasoningEffort`                   | `model.reasoning`                    | —                                                                                                                                                                                                                                                                                                                                                                                                            | RuntimeReasoningEffort | undefined                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| `checkpointRename`                  | `checkpoint.rename`                  | `input`: { id: string; name: string; }                                                                                                                                                                                                                                                                                                                                                                       | RuntimeCheckpoint                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| `planDocList`                       | `planDoc.list`                       | —                                                                                                                                                                                                                                                                                                                                                                                                            | Array<{ planID: string; title: string; documentPath: string; status: string; createdBy: "user" | "live_chat" | "main_agent"; createdAt: string; updatedAt: string; markedAt?: string; }>                                                                                                                                                                                                                                                              |
...
| `planDocDelete`                     | `planDoc.delete`                     | `planID`: string                                                                                                                                                                                                                                                                                                                                                                                             | { deleted: boolean }                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `planDocStatus`                     | `planDoc.status`                     | `planID`: string                                                                                                                                                                                                                                                                                                                                                                                             | { status: string }                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| `teamPRList`                        | `team.pr.list`                       | —                                                                                                                                                                                                                                                                                                                                                                                                            | RuntimeTeamPR[]                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| `requestOverride`                   | `constitution.override.request`      | `input`: { ruleID: string; reason: string; paths?: string[]; taskID?: string; expiresAt?: string; }                                                                                                                                                                                                                                                                                                          | { requested: boolean; requestID?: string; reason?: string }                                                                                                                                                                                                                                                                                                                                                                                           |
