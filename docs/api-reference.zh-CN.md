...
### Capability groups (19 groups · 111 optional members)
...
| intelligence   | `constitutionRules` · `decisionRecords` · `recordDecision` · `evidenceRecords` · `recordValidation` · `driftFindings` · `evaluateDrift` · `registeredTools`                                                                                                                                                           |
...
### RPC route table (116 methods → members)
