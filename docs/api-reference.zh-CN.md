...
### Capability groups (19 groups · 112 optional members)
...
| intelligence   | `constitutionRules` · `decisionRecords` · `recordDecision` · `evidenceRecords` · `recordValidation` · `driftFindings` · `evaluateDrift` · `confirmedWorkspaceChanges` · `registeredTools`                                                                                                                             |
...
### RPC route table (117 methods → members)
