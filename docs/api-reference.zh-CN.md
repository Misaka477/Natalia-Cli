...
### Capability groups (20 groups · 154 optional members)
...
### RPC route table (159 methods → members)
...
### Write surface (`RPC_WRITE_METHODS`, 59 methods; read-only credentials get `-32001 refused`)
...
- Runtime event types (`RuntimeEventData` union): 98.
...
| `workspaceDiff`                     | `workspace.diff`                     | `input?`: { includePatch?: boolean; }                                                                                                                                                                                                                                                                                                                                                                                              | RuntimeWorkspaceDiffChange[]                                                                                                                                                                                                                                                                                                                                                                                                                          |
