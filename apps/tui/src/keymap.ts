...
export const commands: Record<string, CommandDef> = {
  ...
  "constitution.list": {
    id: "constitution.list",
    keys: "unset",
    desc: "Show constitution rules",
  },
  "decision.list": {
    id: "decision.list",
    keys: "unset",
    desc: "Show decision records",
  },
  "evidence.list": {
    id: "evidence.list",
    keys: "unset",
  ...
  "session.snapshot": {
    id: "session.snapshot",
    keys: "unset",
    desc: "Show session intelligence snapshot",
  },
  ...
  "provider.dialog.edit": {
    id: "provider.dialog.edit",
    keys: "alt+e",
    desc: "Edit provider",
    scope: "dialog",
  },
  "provider.dialog.models": {
    id: "provider.dialog.models",
    keys: "alt+m",
    desc: "Manage provider models",
    scope: "dialog",
  },
  "provider.dialog.toggle": {
    id: "provider.dialog.toggle",
    keys: "alt+t",
    desc: "Enable or disable provider",
    scope: "dialog",
  },
  ...
  "provider.model.toggle": {
    id: "provider.model.toggle",
    keys: "alt+t",
    desc: "Enable or disable selected model",
    scope: "dialog",
  },
  ...
  "provider.models.toggle": {
    id: "provider.models.toggle",
    keys: "space",
    desc: "Toggle model selection",
    scope: "dialog",
  },
